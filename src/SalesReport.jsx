      ...
      <div className="salesreport">
        <div className="row">
          <div className="col-xl-10 col-lg-9 col-md-8  p-3">
            <h4 style={{ color: "darkgrey", fontWeight: 400,marginBottom:25 }} className="m-4">
              {" "}
              <strong className="title">Sales Report</strong> September 2020
            </h4>
            <CanvasJSChart options={options} />
          </div>{" "}
          <div className="col-xl-2 col-lg-3 col-md-3 rqbox d-flex flex-column justify-content-center">
            <h4
              className="m-2"
              style={{
                color: "white",
